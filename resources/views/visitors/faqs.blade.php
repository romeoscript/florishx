    ...
    <div class="section section-x bg-primary tc-grey" style="padding-bottom: 0px;">
        <div class="container">
            ...
            <div class="row gutter-vr-30px">
                ...
                <div class="col-12">
                    <div class="faq-item bg-light">
                        <h4>How long does my deposit take before it can reflect on my FLOROUSHX Financial Management Investments account
                            dashboard?</h4>
                ...
                <div class="col-12">
                    <div class="faq-item bg-light">
                        ...
                        <p>Yes we are officially and properly registered with the United States, our company
                            registration number is 602425294 and registered with the name FLOROUSHX LLC</p>
                    </div>
                </div>
                <div class="col-12">
                    <div class="faq-item bg-light">
                ...
                <div class="col-12">
                    <div class="faq-item bg-light">
                        <h4>Is FLOROUSHX LLC and FLOROUSHX Financial Management the same?</h4>
                        <p>FLOROUSHX LLC is group of companies which FLOROUSHX Financial Management is under and most of the executives and
                            team of FLOROUSHX LLC works for FLOROUSHX Financial Management. FLOROUSHX LLC serves as a Parent Company
                            and Affiliate.</p>
                    </div>
                </div>
                <div class="col-12">
