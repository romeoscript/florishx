        ...
        <div class="row align-items-center">
            <div class="col-sm-2 order-last order-sm-first">
                <ul class="social social-alt">
                    {{-- <li><a href="https://t.me/FLOROUSHX Financial ManagementCapital" class="fa fa-paper-plane"></a></li> --}}
            ...
            <div class="col-10 col-sm-9">
                <div class="banner-content">
                    ...
                    <h1 class="banner-heading size-sm">Welcome to FLOROUSHX Financial Management</h1>
                    <div class="banner-btn">
                        <h6>Explore More</h6>
                                                            <a href="{{route('about')}}" class="btn-scroll"><em class="ti-angle-right"></em></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-10 col-xl-8">
                        <div class="banner-content">
                            <h1 class="banner-heading animate t-u" data-animate="fade-in-up" data-delay="0.5" data-duration="0.5">We are experts in financial services</h1>
                            <p class="lead lead-lg animate" data-animate="fade-in-up" data-delay="0.12" data-duration="0.5">Gaining financial independence for all</p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 offset-1 col-xl-8 offset-xl-0">
                        <div class="banner-content">
                            <h1 class="banner-heading animate t-u" data-animate="fade-in-up" data-delay="0.5" data-duration="0.5">Creating wealth for our clients irrespective of market flow</h1>

                            <div class="banner-btn animate" data-animate="fade-in-up" data-delay="0.10" data-duration="0.9">
        ...
        <div class="banner-block tc-light d-flex">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 offset-1 col-xl-8 offset-xl-0">
                        <div class="banner-content">
                            <h1 class="banner-heading animate t-u" data-animate="fade-in-up" data-delay="0.5" data-duration="0.5">There is a suitable plan for everyone</h1>
                            <p class="lead lead-lg animate" data-animate="fade-in-up" data-delay="0.7" data-duration="0.5">Check our pricing plans</p>
                            <div class="banner-btn animate" data-animate="fade-in-up" data-delay="0.10" data-duration="0.9">
...
<div class="row gutter-vr-30px justify-content-between align-items-start align-items-md-start">
    ...
    <div class="col-lg-6">
        <div class="text-block block-pad-b-100">
            <h5 class="heading-xs dash">About FLOROUSHX Financial Management</h5>
...
<div class="container">
    <div class="section-head section-head-s2 section-sm">
                        <h2>Choose an investment product to get started <br><span style="font-weight: 100;">to find out why over {{$company_features? $company_features->totalusers : 0}} users trust FLOROUSHX Financial Management</span></h2>
    </div>
    <div class="row">
        <div class="col">
            <!-- filter menu-->
...
<li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#tabA">CRYPTO</a></li>
<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tabB">STOCKS & ETFs</a></li>
<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tabC">FOREX</a></li>
</ul>
</div>
...
<div class="row">
    <div class="col-md-6 pb-5">
        <div class="text-block">
            ...
            <p class="lead">Deposit, invest, store & sell Bitcoin and other leading cryptos with ease</p>
...
<div class="col-md-6">
        <div class="text-block">
            ...
            <p class="lead">No markup on stocks & ETFs from leading exchanges - no matter how much you invest</p>
...
<p class="card-text">Go long or short on FX from just 1 pip. Trade commodities with flexible leverage.</p>
...
<a href="{{route('register')}}" style="width: fit-content;" class="themebtn">Start Trading</a>
...
<div class="row justify-content-between align-items-center gutter-vr-30px">
    <div class="col-md-5">
        <div class="text-box mrm-20">
            ...
            <p>
                                    FLOROUSHX Financial Management has been at the forefront of the digital fintech revolution since her inception.
                                    </p>
        </div>
    </div><!-- .col -->
    <div class="col-md-6">
        <div class="row no-gutters">
            <div class="col-6">
                <div class="counter counter-s2 counter-bdr border-bottom-0">
                    ...
                    <div class="counter-content counter-content-s2">
                        <h2 class="count" data-count="{{$company_features? $company_features->onlinevisitors : 0}}">{{$company_features? $company_features->onlinevisitors : 0}}</h2>
                        <p>Active Users</p>
                    </div>
                </div>
            </div><!-- .col -->
            <div class="col-6">
                <div class="counter counter-s2 counter-bdr border-bottom-0">
                    ...
                    <div class="counter-content counter-content-s2">
                        <h2 class="count" data-count="{{$company_features? $company_features->started : 0}}">{{$company_features? $company_features->started : 0}}</h2>
                        <p>Running Days</p>
                    </div>
                </div>
            </div><!-- .col -->
            <div class="col-6">
                <div class="counter counter-s2 counter-bdr">
                    ...
                    <div class="counter-content counter-content-s2">
                        <h2 class="count" data-count="{{$company_features? $company_features->totaldeposit : 0}}">{{$company_features? $company_features->totaldeposit : 0}}</h2>
                        <p>Deposits(BTC)</p>
                    </div>
                </div>
            </div><!-- .col -->
            <div class="col-6">
                <div class="counter counter-s2 counter-bdr">
                    ...
                    <div class="counter-content counter-content-s2">
                        <h2 class="mrm-4 count" data-count="{{$company_features? $company_features->totalwithdrawn : 0}}">{{$company_features? $company_features->totalwithdrawn : 0}}</h2>
                        <p>Withdrawals(BTC)</p>
                    </div>
                </div>
            </div><!-- .col -->
...
<div class="container">
    ...
    <div style="width: 100%; background-color: #FFFFFF; overflow:hidden; box-sizing: border-box; text-align: right; line-height:14px; font-size: 12px; box-sizing:content-box; font-feature-settings: normal; text-size-adjust: 100%; padding:1px; margin: 0px;">
        <div style="">
        <!-- TradingView Widget BEGIN -->
<div class="tradingview-widget-container">
<div class="tradingview-widget-container__widget"></div>
...
<div class="row justify-content-between align-items-center gutter-vr-30px">
    ...
    <div class="col-md-6">
        <div class="text-block text-box-ml mtm-15">
                                <h2>Invest in Stocks <br><span style="font-weight: 100;">The advantages of investing in stocks on FLOROUSHX Financial Management don’t end with pricing. There are also huge profit to be made. It is also commission-free.</span> </h2>
                                <a href="{{route('register')}}" class="btn btn-outline">Invest in Stocks</a>
                                <p class="mt-13" style="font-size: 12px;">
                                        Zero-commission means that no broker fee will be charged when opening or closing the position and does not
                                        apply to short or leveraged positions. Other fees apply including FX fees on non-USD deposits and withdrawals.
                                </p>
    ...
    <div style="width: 100%; background-color: #FFFFFF; overflow:hidden; box-sizing: border-box; text-align: right; line-height:14px; font-size: 12px; box-sizing:content-box; font-feature-settings: normal; text-size-adjust: 100%; padding:1px; margin: 0px;">
        <div style="height:40px;">
            <embed src="https://widget.coinlib.io/widget?type=horizontal_v2&amp;theme=light&amp;pref_coin_id=1505&amp;invert_hover=" width="100%" height="36" scrolling="auto" marginwidth="0" marginheight="0" frameborder="0" border="0" style="border:0;margin:0;padding:0;"/>
        ...
        <div class="text-block text-box-ml mtm-15">
                                <h2>Explore an ever-expanding variety of cryptocurrencies,<br>
                                    <span style="font-weight: 100;">
                                        and buy and sell the underlying asset on FLOROUSHX Financial Management’s Cryptocurrency Trading Platform.
...
<div class="row gutter-vr-30px align-items-center justify-content-between">
    <div class="col-lg-8 text-center text-lg-left">
        <div class="cta-text-s2">
            <h2><span>Ready to take a</span> <strong style="font-weight: 800; font-size: 30px;">BOLD STEP?</strong></h2>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="text-block text-box-ml mtm-15">
                                ...
                                <p class="mt-13" style="font-size: 12px;">
                                        ...
                                        FLOROUSHX Financial Management.
                                </p>
                ...
                <div class="tes-author d-flex align-items-center">
                    ...
                    <div class="author-con">
                        <h6 class="author-name t-u">Alexandra lukas</h6>
                                                            <span class="fa fa-star check-star"></span><span class="fa fa-star check-star"></span><span class="fa fa-star check-star"></span><span class="fa fa-star check-star"></span><span class="fa fa-star check-star"></span>								</div>
                </div>
            </div><!-- .tes-block -->

                                                            <div class="tes-block">
                <div class="tes-content bg-light shadow-alt">
                                                <p>I'm retired but FLOROUSHX Financial Management got me! Real estate on here and crypto is bullish</p>
                </div>
                <div class="tes-author d-flex align-items-center">
                    <div class="author-image">
                    ...
                    <div class="author-con">
                        <h6 class="author-name t-u">Alex Philidor</h6>
                                                            ...
                                                            <div class="tes-block">
                <div class="tes-content bg-light shadow-alt">
                                                <p>I appreciate my colleagues for introducing me to FLOROUSHX Financial Management, it's been wow since I started investing 6 months ago</p>
                </div>
                <div class="tes-author d-flex align-items-center">
                    <div class="author-image">
                    ...
                    <div class="author-con">
                        <h6 class="author-name t-u">Frode Hedegaard</h6>
                                                            ...
                                                            <div class="tes-block">
                <div class="tes-content bg-light shadow-alt">
                                                <p>You don't necessarily need to be a trader before you can Gain in the market, I enjoy investing here as I'm a passive Investor</p>
                </div>
                <div class="tes-author d-flex align-items-center">
                    <div class="author-image">
                    ...
                    <div class="author-con">
                        <h6 class="author-name t-u">Enoch Stewart</h6>
                                                            ...
                                                            <div class="tes-block">
                <div class="tes-content bg-light shadow-alt">
                                                <p>Ever since I started investing with FLOROUSHX Financial Management since lockdown period, I've not had issues with them</p>
                </div>
                <div class="tes-author d-flex align-items-center">
                    <div class="author-image">
                    ...
                    <div class="author-con">
                        <h6 class="author-name t-u">Christiane Bescond</h6>
                                                            ...
                                                            <div class="tes-block">
                <div class="tes-content bg-light shadow-alt">
                                                <p>I will never advocate anything that has to do with scam, so it's legit and transparent, I started with $1000, my positions with FLOROUSHX Financial Management has increased since 4 months</p>
                </div>
                <div class="tes-author d-flex align-items-center">
                    <div class="author-image">
                    ...
                    <div class="author-con">
                        <h6 class="author-name t-u">Oswald Dixon</h6>
                                                            ...
                                                            <div class="tes-block">
                <div class="tes-content bg-light shadow-alt">
                                                <p>FLOROUSHX Financial Management is real, genuine and not a scam. I invested and I got paid</p>
                </div>
                <div class="tes-author d-flex align-items-center">
                    <div class="author-image">
                    ...
                    <div class="author-con">
                        <h6 class="author-name t-u">Rodney wickman</h6>
                                                            ...
                                                            <div class="tes-block">
                <div class="tes-content bg-light shadow-alt">
                                                <p>I got furloughed during the COVID-19, I couldn't survive, until a friend recommended FLOROUSHX Financial Management, I can't imagine myself going back to work ever since I started investing with FLOROUSHX Financial Management</p>
                </div>
                <div class="tes-author d-flex align-items-center">
                    <div class="author-image">
                    ...
                    <div class="author-con">
                        <h6 class="author-name t-u">Lieven Swinkels</h6>
                                                            ...
                                                            <div class="tes-block">
                <div class="tes-content bg-light shadow-alt">
                                                <p>I'm happy that I can compound for months and receive my returns at the end of my investment, thanks FLOROUSHX Financial Management</p>
                </div>
                <div class="tes-author d-flex align-items-center">
                    <div class="author-image">
                    ...
                    <div class="author-con">
                        <h6 class="author-name t-u">Tonny Moens</h6>
                                                            ...
                                                            <div class="tes-block">
                <div class="tes-content bg-light shadow-alt">
                                                <p>I did my DD before I started investing, and so far, I'm not regretting, it's almost a year now</p>
                </div>
                <div class="tes-author d-flex align-items-center">
                    <div class="author-image">
