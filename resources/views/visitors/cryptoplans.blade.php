                ...
                <div class="row align-items-center">
                    <div class="col-md-7 col-sm-9">
                        <div class="banner-content">
                            ...
                            <h1 class="banner-heading">Crypto Investment</h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-8 text-center">
                    <div class="section-head section-md res-m-btm">
                        ...
                        <h2 class="fw-1">Crypto Investment</h2>
                    </div>
                </div><!-- .col -->
            </div><!-- .row -->
                    ...
                    <div class="pricing-boxed pricing-boxed-s2">
                        ...
                        <div class="pricing-feature pricing-feature-s2">
                            <ul>
                                ...
                                <li>Monthly Profit <b>{{$plan->percentage  * 30}}%</b></li>
                                <li>Daily  Profit <b>{{$plan->percentage }}%</b></li>

                                <li>Duration <b>{{substr(Carbon\Carbon::now()->addDays($plan->noofrepeat)->diffForHumans(), 0, -8)}}</b></li>
                            </ul>
                        </div>
