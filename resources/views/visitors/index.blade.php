...
@section('body')
            ...
            <div class="row gutter-vr-30px justify-content-between align-items-start align-items-md-start">
                ...
                <div class="col-lg-6 order-lg-last" style="width: 100%;">
                    <div class="image-block">
                        <img src="images/bg-22.jpg" alt="" style="width: 100%;">
                    </div>
                </div><!-- .col -->
            </div>
    ...
    <div class="section section-counter tc-light  bg-dark-alt">
        <div class="container">
            ...
            <div class="row gutter-vr-30px justify-content-between align-items-start    section-counter tc-light  bg-dark-alt"
                ...
                <div class="col-lg-6">
                    <div class="text-block block-pad-b-100">
                        <h5 class="heading-xs dash">FLOROUSHX Financial Management Exchange</h5>
        ...
        <div class="container">
            <div class="section-head section-head-s2 section-sm">
                <h2>Choose an investment product to get started <br><span style="font-weight: 100;">to find out why over
                        {{ $company_features ? $company_features->totalusers : 0 }} users trust FLOROUSHX Financial
                        Management</span></h2>
            </div>
            <div class="row">
                <div class="col">
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="tabA">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="image-block">
                                <img src="images/earth.png" alt="" class="earthy" >
                            </div>
                        </div>
            ...
            <div class="row justify-content-between align-items-center gutter-vr-30px">
                <div class="col-md-5">
                    <div class="text-box mrm-20">
                        ...
                        <p>
                            FLOROUSHX Financial Management has been at the forefront of the digital fintech revolution
                            since her inception.
                        </p>
                    </div>
                </div><!-- .col -->
    ...
    <!--section class="chart-section bg-22olor-3">
                ...
                <div class="col-md-6">
                    <div class="text-block text-box-ml mtm-15">
                        <h2>Invest in Stocks <br><span style="font-weight: 100;">The advantages of investing in stocks on
                                FLOROUSHX Financial Management don’t end with pricing. There are also huge profit to be
                    ...
                    <div class="text-block text-box-ml mtm-15">
                        <h2>Explore an ever-expanding variety of cryptocurrencies,<br>
                            <span style="font-weight: 100;">
                                and buy and sell the underlying asset on FLOROUSHX Financial Management’s
    ...
    <div class="section section-cta tc-light has-bg-image">
        ...
        <div class="bg-image bg-fixed overlay-fall bg-image-loaded" style="background-image: url(_images/bg-22.html);">
                ...
                <div class="container">
                    ...
                    <div class="tes tes-s3">
                        <div class="row has-carousel" data-items="3" data-loop="true" data-auto="true" data-dots="true">
                            ...
                            <div class="tes-block">
                                <div class="tes-content bg-light shadow-alt">
                                    <p>I'm retired but FLOROUSHX Financial Management got me! Real estate on here and
                                        crypto is bullish</p>
                                </div>
                                <div class="tes-author d-flex align-items-center">
                                    <div class="author-image">
                            ...
                            <div class="tes-block">
                                <div class="tes-content bg-light shadow-alt">
                                    <p>I appreciate my colleagues for introducing me to FLOROUSHX Financial Management,
                            ...
                            <div class="tes-block">
                                <div class="tes-content bg-light shadow-alt">
                                    <p>Ever since I started investing with FLOROUSHX Financial Management since
                                        lockdown
                            ...
                            <div class="tes-block">
                                <div class="tes-content bg-light shadow-alt">
                                    <p>I will never advocate anything that has to do with scam, so it's legit and
                                        transparent, I
                                        started with $1000, my positions with FLOROUSHX Financial Management has
                                        increased
                                        since 4 months</p>
                                </div>
                                <div class="tes-author d-flex align-items-center">
                            ...
                            <div class="tes-block">
                                <div class="tes-content bg-light shadow-alt">
                                    <p>FLOROUSHX Financial Management is real, genuine and not a scam. I invested and I
                                        got
                                        paid</p>
                                </div>
                                <div class="tes-author d-flex align-items-center">
                            ...
                            <div class="tes-block">
                                <div class="tes-content bg-light shadow-alt">
                                    <p>I got furloughed during the COVID-19, I couldn't survive, until a friend recommended
                                        ...
                                        I
                                        started investing with FLOROUSHX Financial Management</p>
                                </div>
                                <div class="tes-author d-flex align-items-center">
                                    <div class="author-image">
                            ...
                            <div class="tes-block">
                                <div class="tes-content bg-light shadow-alt">
                                    <p>I'm happy that I can compound for months and receive my returns at the end of my
                                        investment, thanks FLOROUSHX Financial Management</p>
                                </div>
                                <div class="tes-author d-flex align-items-center">
                                    <div class="author-image">
